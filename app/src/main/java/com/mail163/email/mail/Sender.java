...
import com.mail163.email.mail.transport.SmtpSender;
...
public abstract class Sender {
    ...
    private static Sender instantiateSender(Context context, String uri)throws MessagingException {
        if (uri.startsWith("smtp")) {
            return SmtpSender.newInstance(context,uri);
        } else {
    ...
    public synchronized static Sender getInstance(Context context, String uri)
        ...
        if (sender == null) {
    	   ...
    	   /*------实例化实现------*/
            sender = instantiateSender(context, uri);
    ...
    public Class<? extends android.app.Activity> getSettingActivityClass() {
        ...
        return com.mail163.email.activity.setup.AccountSetupOutgoing.class;
    }
