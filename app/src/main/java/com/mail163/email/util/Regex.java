...
public class Regex {
    ...
    //电信：133、153、180、189
    public static final Pattern CHINA_PHONE_PATTERN = Pattern
            .compile("^((13[0-9])|(15[^4,\\D])|(18[0,5-9]))\\d{8}$");

    //移动：134、135、136、137、138、139、150、151、152, 157(TD)、158、159、187、188
    public static final Pattern CHINA_MOBILE_PHONE_PATTERN = Pattern
            .compile("^1(3[4-9]|5[012789]|8[78])\\d{8}$");

    //电信：133、153、180、189
    public static final Pattern CHINA_TELECOM_PHONE_PATTERN1 = Pattern
            .compile("^1(33|53|8[09])\\d{8}$");

    //联通：130、131、132、155、156、185、186
    public static final Pattern CHINA_UNICOM_PHONE_PATTERN = Pattern
            .compile("^1(3[0-2]|5[56]|8[56])\\d{8}$");
