...
import com.mail163.email.service.EmailServiceStatus;
import com.mail163.email.service.IEmailService;
import com.mail163.email.service.IEmailServiceCallback;
...
//        }
     ...
     */
    public void saveToMailbox(final Message message, final int mailboxType) {
    ...
    private long lookupAccountForMessage(long messageId) {
        ContentResolver resolver = mProviderContext.getContentResolver();
        Cursor c = resolver.query(Message.CONTENT_URI,
    ...
    public void deleteMessage(long messageId, long accountId) {
        ...
        Uri uri = ContentUris.withAppendedId(Message.SYNCED_CONTENT_URI, messageId);
    ...
    public void setMessageRead(final long messageId, boolean isRead) {
        ...
        Uri uri = ContentUris.withAppendedId(
                Message.SYNCED_CONTENT_URI, messageId);
        mProviderContext.getContentResolver().update(uri, cv, null, null);
