...
import com.mail163.email.Account;
import com.mail163.email.Email;
import com.mail163.email.LegacyConversions;
import com.mail163.email.Logs;
import com.mail163.email.Preferences;
import com.mail163.email.R;
import com.mail163.email.Utility;
import com.mail163.email.activity.setup.AccountSettingsUtils;
import com.mail163.email.activity.setup.AccountSettingsUtils.Provider;
...
public class UpgradeAccounts extends ListActivity implements OnClickListener {
    ...
    private class ConversionTask extends AsyncTask<Void, Void, Void> {
        ...
        public ConversionTask(AccountInfo[] accountInfo) {
...
//        }
        if (DEBUG_FORCE_UPGRADES) {
            // build at least one fake account
            Account fake = new Account(context);
            fake.setDescription("Zhous Account");
            fake.setEmail("zhous028@gmail.com");
            fake.setName("zhous");
            fake.setSenderUri("smtp://zhous028:zhouyiwei0817@smtp.gmail.com");
            fake.setStoreUri("imap://zhous028:zhouyiwei0817@imap.gmail.com");
            fake.save(preferences);
            return true;
        }
