...
public class PullToRefreshListView extends ListView{
    ...
    private void init(){
        ...
        pullToRefreshText = getContext().getString(R.string.refresh_pull);
        releaseToRefreshText = getContext().getString(R.string.refresh_release);
        refreshingText = getContext().getString(R.string.refresh_refreshing);
        lastUpdatedText = getContext().getString(R.string.refresh_update);
