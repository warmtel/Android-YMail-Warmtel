...
public class AccountSetupOutgoing extends Activity implements OnClickListener,
    ...
    private CheckBox mDisplayPasswordView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayPasswordView = (CheckBox)findViewById(R.id.display_password);
        ...
        mDisplayPasswordView.setOnCheckedChangeListener(checkBox_Listener); 
        ...
        try {
            ...
            if (uri.getHost() != null) {
            	if(!uri.getHost().startsWith("smtp")){
            		mServerView.setText("smtp."+uri.getHost());
            	}else{
    ...
    private OnCheckedChangeListener checkBox_Listener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
			if(mDisplayPasswordView.isChecked()){
