...
import com.mail163.email.mail.Body;
...
public class LegacyConversions {
    ...
    public static boolean updateMessageFields(EmailContent.Message localMessage, Message message,
        ...
        if (Priority != null) {
            localMessage.mPriority = Priority;
        }
...
//            cv.put(AttachmentColumns.MIME_TYPE, "image/png");
    ...
    public static Message makeMessage(Context context, EmailContent.Message localMessage)
        ...
        message.setPriority(localMessage.mPriority == null ? "" : localMessage.mPriority);
...
//        }
     ...
     * @return an Account ready to be committed to provider
     */
    public static Mailbox makeMailbox(Context context, EmailContent.Account toAccount,
