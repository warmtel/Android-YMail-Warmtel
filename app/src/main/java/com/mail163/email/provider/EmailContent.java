...
public abstract class EmailContent {
    ...
    public static final class Message extends EmailContent implements SyncColumns, MessageColumns {
        ...
        public static final int CONTENT_SIZE = 21;
        public static final int CONTENT_PRIORITY = 22;
        ...
        public ContentValues toContentValues() {
            ...
            values.put(MessageColumns.PRIORITY, mPriority);
            return values;
        }
        ...
        @Override
        @SuppressWarnings("unchecked")
        public Message restore(Cursor c) {
            mBaseUri = CONTENT_URI;
            ...
            mSize = c.getLong(CONTENT_SIZE);
            mPriority = c.getString(CONTENT_PRIORITY);
            return this;
        }
    ...
    public static final class Account extends EmailContent implements AccountColumns, Parcelable {
         ...
         * {@link com.mail163.email.AccountBackupRestore} won't preserve it.
         */
    ...
    public static final class Mailbox extends EmailContent implements SyncColumns, MailboxColumns {
        ...
        //�½��ʼ�
        public static final int TYPE_NEWBOX = 8;
        ...
        public static final long QUERY_ALL_SEARCH_INBOX = -7;//����
        public Mailbox() {
            mBaseUri = CONTENT_URI;
        }
    ...
    public static final class HostAuth extends EmailContent implements HostAuthColumns, Parcelable {
        ...
        public static HostAuth restoreHostAuthWithId(Context context, long id) {
            Uri u = ContentUris.withAppendedId(HostAuth.CONTENT_URI, id);
        ...
        public String getStoreUri() {
            ...
            try {
                uri = new URI(
                        ...
                        null,
                        null);
//                Logs.v(Logs.LOG_TAG, "uri :"+uri.toString());
                return uri.toString();
    ...
    public interface EmailContactColumns {
        public static final String ID = "_id";
        static final String USERNAME = "username";
        static final String EMAIL = "email";
    }
    
    public static final class EmailContact extends EmailContent implements EmailContactColumns, Parcelable {
        public static final String TABLE_NAME = "emailcontact";
        public static final Uri CONTENT_URI = Uri.parse(EmailContent.CONTENT_URI + "/emailcontact");

        public String mUserName;
        public String mEmail;

        public static final int CONTENT_ID_COLUMN = 0;
        public static final int CONTENT_USERNAME_COLUMN = 1;
        public static final int CONTENT_EMAIL_COLUMN = 2;

        public static final String[] CONTENT_PROJECTION = new String[] {
            RECORD_ID, EmailContactColumns.USERNAME, EmailContactColumns.EMAIL
        };
        ...
        public ContentValues toContentValues() {
            ContentValues values = new ContentValues();
            values.put(EmailContactColumns.USERNAME, mUserName);
            values.put(EmailContactColumns.EMAIL, mEmail);
            return values;
        }

        @SuppressWarnings("unchecked")
        @Override
        public EmailContact restore(Cursor cursor) {
            mBaseUri = CONTENT_URI;
            mId = cursor.getLong(CONTENT_ID_COLUMN);
            mUserName = cursor.getString(CONTENT_USERNAME_COLUMN);
            mEmail = cursor.getString(CONTENT_EMAIL_COLUMN);
            return this;
        }
    }
}
