package com.mail163.email.provider;/*package com.mail163.email.provider;

import com.mail163.email.R;
import com.mail163.email.mail.MessagingException;
import com.mail163.email.mail.store.LocalStore;
import com.mail163.email.provider.AttachmentProvider.AttachmentProviderColumns;
 ...
 *   runtest -c com.mail163.email.provider.AttachmentProviderTests email
 *//*
public class AttachmentProviderTests extends ProviderTestCase2<AttachmentProvider> {
    ...
    *//**
     ...
     *//*
    public void _testUnimplemented() {
    ...
    *//**
     ...
     *  - permuted projection
     *//*
    public void _testQuery() throws MessagingException {
    ...
    *//**
     ...
     *  - thumbnail
     *//*
    public void _testGetType() throws MessagingException {
    ...
    *//**
     ...
     *//*
    public void _testInferMimeType() {
    ...
    *//**
     ...
     *//*
    public void _testOpenFile() throws MessagingException, IOException {
    ...
    *//**
     ...
     *//*
    public void _testOpenThumbnail() throws MessagingException, IOException {
    ...
    *//**
     ...
     *//*
    public void _testResolveAttachmentIdToContentUri() throws MessagingException {
        Account account1 = ProviderTestUtils.setupAccount("attachment-query", false, mMockContext);
        account1.mCompatibilityUuid = "test-UUID";
        account1.save(mMockContext);
        final long message1Id = 1;
    ...
    *//**
     ...
     *//*
    public void _testDeleteFiles() throws IOException {
        Account account1 = ProviderTestUtils.setupAccount("attachment-query", false, mMockContext);
        account1.mCompatibilityUuid = "test-UUID";
        account1.save(mMockContext);
    ...
    *//**
     ...
     *//*
    public void _testDeleteMailbox() throws IOException {
